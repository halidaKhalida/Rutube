...
const Soccer = () => {
  ...
  return (
    <div className="flex flex-col w-full h-auto pb-[80px] overflow-x-hidden absolute  px-[147px] mt-[24px] bg-[#14191F]">
      <div>
        <h1 className="w-[270px] pl-[18px]   text-white text-[36px] font-semibold ">Футбол</h1>
        <div>
          <Swiper
      ...
      <div className=" mt-[42px] ">
        <h1 className="w-[370px] pl-[18px]   text-white text-[36px] font-semibold ">Обзоры Евро-2024</h1>
        <div>
          <Swiper
            // install Swiper modules
            modules={[Navigation, A11y, Autoplay]}
            ...
            onSwiper={(swiper) => console.log(swiper)}
            onSlideChange={() => console.log("slide change")}
            className="w-full px-[20px] flex gap-[16px] mt-[16px] swip"
          >
            {swipOne.map((m) => (
              <SwiperSlide className="" key={m.id}>
                <Link to={`/Films/${m.id}`}>
                <Cards_long_video img={m.img} long_time={m.long_time} img_age={m.img_age} chanel_img={m.chanel_img} text={m.text} chanel_name={m.chanel_name} prosmotri={m.prosmotri} time={m.time} />
                </Link>
              </SwiperSlide>
            )
            )}
      ...
      <div className=" mt-[42px] ">
        <h1 className="w-[370px] pl-[18px]   text-white text-[36px] font-semibold ">Обзоры матчей</h1>
        <div>
          <Swiper
            // install Swiper modules
            modules={[Navigation, A11y, Autoplay]}
      ...
      <div className=" mt-[42px] ">
        <h1 className="w-[370px] pl-[18px]   text-white text-[36px] font-semibold ">ПФК ЦСКА</h1>
        <div>
          <Swiper
            // install Swiper modules
            modules={[Navigation, A11y, Autoplay]}
